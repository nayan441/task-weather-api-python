...
async def fetch_weather_data_async(city, session):
    try:
        url = f'http://api.openweathermap.org/data/2.5/forecast?q={city}&cnt=6&appid={api_key}'
...
async def main(cities):
    # cities = ['city1', 'city2', 'city3']  # Add the list of cities you want to fetch data for
